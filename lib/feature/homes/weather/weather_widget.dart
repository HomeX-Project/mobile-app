...
import 'package:home_x/feature/homes/weather/data/weather_model.dart';
import 'package:home_x/feature/homes/weather/service/weather_service.dart';
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          ...
          return SizedBox(
            height: 40,
            width: 40,
            child:Text("No Image")   , // Image.asset(Assets.assetsImagesNoWeather),
          );
        } else {
